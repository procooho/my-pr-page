...
import { ArrowUpRight, Download, Linkedin, Lock, Unlock } from 'lucide-react';
                    ...
                    <div className="flex flex-col items-start md:items-end gap-2 text-left md:text-right">
                        {!isContactRevealed ? (
                            <button
                                ...
                                className="relative flex items-center gap-2 text-yellow-400 hover:text-white transition-colors font-mono text-sm border border-yellow-400/30 px-3 py-1 rounded bg-yellow-400/5 hover:bg-yellow-400/10 animate-bounce"
                            >
