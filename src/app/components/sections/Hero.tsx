        ...
        <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-black">
            ...
            >
                ...
                <div className="flex items-center justify-center gap-4 mb-4 opacity-70">
                    ...
                    <span className="font-mono text-xs tracking-[0.3em] text-white">DEVELOPER PORTFOLIO</span>
                    <div className="h-[1px] w-12 bg-white/50" />
                </div>
                    ...
                    <div className="relative bg-black/40 border border-white/10 backdrop-blur-md p-4 md:p-6 rounded-sm overflow-hidden group hover:border-yellow-400/30 transition-colors duration-500 hover:shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="flex flex-col gap-2 md:gap-4 font-mono text-left">
                            <div className="flex justify-between items-center text-[10px] text-yellow-500/70 tracking-[0.2em] uppercase border-none pb-0 md:border-b border-white/5 md:pb-2">
                                <span className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-yellow-400 rounded-full animate-pulse" /> MY OBJECTIVE</span>
                            ...
                            <div className="flex flex-col gap-1 md:gap-2 py-0 md:py-1">
                                ...
                                <div className="hidden md:flex pl-6 flex-col gap-3 border-l border-white/10 ml-1.5 my-1">
                                    <div className="flex items-center gap-3 text-base">
                                        <span className="text-[10px] text-gray-500 font-mono tracking-wider w-12">CONCEPT:</span>
                                        <span className="text-white font-bold decoration-yellow-400/30 underline decoration-1 underline-offset-4">Brilliant Ideas</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-base">
                                        <span className="text-[10px] text-gray-500 font-mono tracking-wider w-12">REALITY:</span>
                                        <span className="bg-yellow-400/10 text-yellow-400 px-2 py-0.5 rounded border border-yellow-400/20 shadow-[0_0_10px_rgba(255,215,0,0.1)] font-bold whitespace-nowrap">Engineered Reality</span>
                                    </div>
                                </div>
                                ...
                                <div className="md:hidden mt-0 pl-2 border-l-2 border-yellow-400/20 ml-1">
                                    <p className="text-xs text-gray-300 leading-6">
                                        Converting <span className="text-white font-bold border-b border-white/20">brilliant ideas</span> into <br />
                                        <span className="text-yellow-400 font-bold bg-yellow-400/10 px-1.5 py-0.5 rounded border border-yellow-400/20 text-[10px] tracking-wider inline-block mt-0.5">Engineered Reality</span>
                                    </p>
                                </div>
                            </div>
